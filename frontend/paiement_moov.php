...
$traductions = [
    'fr' => [
        'title' => "Paiement par Moov",
        'summary' => "Résumé de l’abonnement",
        'feature' => "Fonctionnalités incluses",
        'price' => "Prix",
        'currency' => "Devise",
        'moov_number' => "Numéro Moov pour le dépôt",
        'enter_reference' => "Référence Moov (reçue par SMS)",
    ...
    'en' => [
        'title' => "Payment via Moov",
        'summary' => "Subscription Summary",
        'feature' => "Included Features",
        'price' => "Price",
        'currency' => "Currency",
        'moov_number' => "Moov number for deposit",
        'enter_reference' => "Moov Reference (SMS received)",
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($reference)) {
        ...
        // Sauvegarde de la preuve si tout est valide
        $methode = 'moov';
...
<form method="post" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <p><strong>+228 97507733</strong></p> <!-- Remplace avec ton vrai numéro Moov -->
    </div>
